...
[![PyPI](https://img.shields.io/pypi/v/golden-ration-ns?color=9D50DC)](https://pypi.org/project/golden-ration-ns/)
[![Python](https://img.shields.io/pypi/pyversions/golden-ration-ns)](https://pypi.org/project/golden-ration-ns/)
...
Небольшой калькулятор на фронтенде (перевод чисел и арифметика в фи-еричной системе) — https://demiushttv.github.io/GoldenRatioNS/
...
```bash
pip install golden-ration-ns
# или
uv add golden-ration-ns
```
...
<table>
  <tr>
    <td align="center">
      ...
      <br />
      <a href="mailto:anaermakova948@gmail.com">anaermakova948@gmail.com</a>
    </td>
    <td align="center">
      ...
      <br />
      <a href="mailto:babygreenyoda@yandex.ru">babygreenyoda@yandex.ru</a>
    </td>
  </tr>
</table>
